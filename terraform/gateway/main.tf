...
module "aws_deploy-main-us-west-2" {
  source            = "git::https://github.com/aeternity/terraform-aws-aenode-deploy.git?ref=v1.0.0"
  env               = "api_main"
...
module "aws_gateway" {
  ...
  source   = "git::https://github.com/aeternity/terraform-aws-api-gateway.git?ref=v1.0.0"
  dns_zone = "${var.dns_zone}"
