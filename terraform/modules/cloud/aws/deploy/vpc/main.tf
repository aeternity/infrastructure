...
resource "aws_subnet" "subnet" {
  ...
  cidr_block              = "10.0.${count.index+length(split(",", lookup(var.availability_zones, data.aws_region.current.name)))}.0/24" #small hack to be able to recreate subnets without conflict.
