...
ansible-playbook -vvvv -e 'ansible_python_interpreter="/usr/bin/env python"' environments.yml
ansible-playbook -vvvv -e 'ansible_python_interpreter="/usr/bin/env python"' --limit=epoch setup.yml
